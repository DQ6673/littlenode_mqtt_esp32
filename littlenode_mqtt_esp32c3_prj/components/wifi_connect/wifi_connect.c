...
#define WIFI_SSID "dpm"
#define WIFI_PASSWORD "123456789"
#define WIFI_THRESHOLD_AUTHMODE WIFI_AUTH_WPA2_PSK
...
void wifi_init_sta(void)
{
     ...
     * number of re-tries (WIFI_FAIL_BIT). The bits are set by wifi_connect_event_handler() (see above) */
